...
func (m *MockApiClient) SetApiClient(apiKey, refreshToken string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetApiClient", apiKey, refreshToken)
}

// SetApiClient indicates an expected call of SetApiClient.
func (mr *MockApiClientMockRecorder) SetApiClient(apiKey, refreshToken interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetApiClient", reflect.TypeOf((*MockApiClient)(nil).SetApiClient), apiKey, refreshToken)
}
